...
public static class Constants
{
    ...
    public const int PositionMinimumXZ = -1024 * UnitsPerMeter;
    public const int PositionMaximumXZ = ( 1024 * UnitsPerMeter ) - 1;
    public const int PositionMinimumY = (-64 * UnitsPerMeter ) - 1;  
    public const int PositionMaximumY = ( 1024 * UnitsPerMeter ) - 1;
    ...
    public const int LocalPositionMinimum = -1024 * UnitsPerMeter;
    public const int LocalPositionMaximum = (1024 * UnitsPerMeter ) - 1;
