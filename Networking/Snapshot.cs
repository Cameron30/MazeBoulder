...
public class Snapshot
{
   ...
   public static void GetState( Rigidbody rigidBody, ref State cubeState, ref Vector3 origin )
    {
    ...
    public static void UpdateCubeState( Rigidbody rigidBody, ref State cubeState, ref Vector3 origin, bool smoothing = false )
    {
        ...
        */
        Vector3 position = new Vector3( cubeState.position_x, cubeState.position_y, cubeState.position_z ) * 1.0f / Constants.UnitsPerMeter;
